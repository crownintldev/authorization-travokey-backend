const abilityProvider = (req, res, next) => {
  ...
  // Create a structured subject with conditions
  const subject = { type: subjectType, module: moduleKey };

  console.log("Checking ability with structured subject:", { action, subject });
